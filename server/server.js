...
app.use(function (req, res, next) {
    res.header("Access-Control-Allow-Origin", 'https://meyespace-frontend.com'); //<-- you can change this with a specific url like http://localhost:4200
...
app.post('/register', (req, res) => {
    ...
    user.save().then(() => {
        ...
        axiosPostCall(process.env.STAT_API_URL, _saveUserToDb, { _userId: user._id });
